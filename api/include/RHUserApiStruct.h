...
struct CRHMonitorPositionField
{
	...
	/// 证券持仓余额
	TRHVolumeType OrigVolume;
	/// 证券持仓可用
	TRHVolumeType AvailPosition;
	/// 证券持仓今买入
	TRHVolumeType TodayBuyVolume;
	/// tas持仓手数
	TRHVolumeType TasPosition;
	/// tas持仓成本
	TRHMoneyType TasPositionCost;
};
...
struct CRHOrderField
{
	...
	TRHMacAddressType MacAddress;
	/// 指令编号
	TRHInstructionidType Instructionid;
};
...
struct CRHQryOrderField
{
	...
	TRHOrderSysIDType OrderSysID;
	/// 开始时间
	TRHTimeType InsertTimeStart;
	/// 结束时间
	TRHTimeType InsertTimeEnd;
	/// 投资单元代码
	TRHInvestUnitIDType InvestUnitID;
	/// 前置编号
	TRHFrontIDType FrontID;
...
struct CRHQryTradeField
{
	...
	TRHTradeIDType TradeID;
	/// 开始时间
	TRHTimeType TradeTimeStart;
	/// 结束时间
	TRHTimeType TradeTimeEnd;
	/// 投资单元代码
	TRHInvestUnitIDType InvestUnitID;
};

struct CRHMonitorInstrumentField
{
	/// 合约代码
	TRHInstrumentIDType InstrumentID;
	/// 交易所代码
	TRHExchangeIDType ExchangeID;
	/// 合约名称
	TRHInstrumentNameType InstrumentName;
	/// 合约在交易所的代码
	TRHExchangeInstIDType ExchangeInstID;
	/// 产品代码
	TRHInstrumentIDType ProductID;
	/// 产品类型
	TRHProductClassType ProductClass;
	/// 交割年份
	TRHYearType DeliveryYear;
	/// 交割月
	TRHMonthType DeliveryMonth;
	/// 市价单最大下单量
	TRHVolumeType MaxMarketOrderVolume;
	/// 市价单最小下单量
	TRHVolumeType MinMarketOrderVolume;
	/// 限价单最大下单量
	TRHVolumeType MaxLimitOrderVolume;
	/// 限价单最小下单量
	TRHVolumeType MinLimitOrderVolume;
	/// 合约数量乘数
	TRHVolumeMultipleType VolumeMultiple;
	/// 最小变动价位
	TRHPriceType PriceTick;
	/// 创建日
	TRHDateType CreateDate;
	/// 上市日
	TRHDateType OpenDate;
	/// 到期日
	TRHDateType ExpireDate;
	/// 开始交割日
	TRHDateType StartDelivDate;
	/// 结束交割日
	TRHDateType EndDelivDate;
	/// 合约生命周期状态
	TRHInstLifePhaseType InstLifePhase;
	/// 当前是否交易
	TRHBoolType IsTrading;
	/// 持仓类型
	TRHPositionTypeType PositionType;
	/// 持仓日期类型
	TRHPositionDateTypeType PositionDateType;

	/// 多头保证金率
	TRHRatioType LongMarginRatioByMoney;
	/// 多头保证金费
	TRHMoneyType LongMarginRatioByVolume;
	/// 空头保证金率
	TRHRatioType ShortMarginRatioByMoney;
	/// 空头保证金费
	TRHMoneyType ShortMarginRatioByVolume;
	/// 午盘保证金率
	TRHMoneyType AfternoonMarginRatioByMoney;
	/// 午盘保证金费
	TRHMoneyType AfternoonMarginRatioByVolume;
	/// 隔夜保证金率
	TRHMoneyType OvernightMarginRatioByMoney;
	/// 隔夜保证金费
	TRHMoneyType OvernightMarginRatioByVolume;
	/// 是否相对交易所收取
	TRHBoolType MarginIsRelative;

	/// 开仓手续费率
	TRHRatioType OpenRatioByMoney;
	/// 开仓手续费
	TRHRatioType OpenRatioByVolume;
	/// 平仓手续费率
	TRHRatioType CloseRatioByMoney;
	/// 平仓手续费
	TRHRatioType CloseRatioByVolume;
	/// 平今手续费率
	TRHRatioType CloseTodayRatioByMoney;
	/// 平今手续费
	TRHRatioType CloseTodayRatioByVolume;
	// 基础商品代码
	TRHInstrumentIDType UnderlyinginstrID;
	/// 执行价
	TRHPriceType StrikePrice;
	/// 期权类型
	TRHOptionsTypeType OptionsType;
	/// 合约基础商品乘数
	TRHUnderlyingMultipleType UnderlyingMultiple;
	/// 组合类型
	TRHCombinationTypeType CombinationType;
};
#endif
